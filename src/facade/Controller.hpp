...
struct Controller_t
{
    ...
    virtual void createWindow(uint32_t w,uint32_t h) = 0; //este solo crea la ventana y recoge las instancias del video driver, scene manager y guienvironment;
